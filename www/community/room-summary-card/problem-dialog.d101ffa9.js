...
class $af67bf6c1cd47cdf$export$5ef45279fcb54955 extends (0, $wgzUt.SubscribeEntityStateMixin)((0, $1LdRn.HassUpdateMixin)((0, $fPVm8.LitElement))) {
   ...
   */ render() {
        ...
        const s = this.state;
        const isActive = (0, $cmVfz.stateActive)(s);
        const displayName = (0, $el4XD.computeEntityName)(s, this.hass) || s.entity_id;
...
//# sourceMappingURL=problem-dialog.d101ffa9.js.map
